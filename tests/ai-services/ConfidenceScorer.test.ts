...
describe("ConfidenceScorer", () => {
  describe("calculateInputCompleteness", () => {
    ...
    it("increases score with description length", () => {
      ...
      const longScore = calculateInputCompleteness({
        description:
          "A much longer description that provides more context and details about the project requirements and goals".repeat(
            5
          ),
      });
  ...
  describe("generateClarifyingQuestions", () => {
    it("generates questions for low input completeness", () => {
      const questions = generateClarifyingQuestions("Features", {
        inputCompleteness: 0.3,
        aiSelfAssessment: 0.8,
        patternMatch: 0.7,
      });
    ...
    it("generates questions for low pattern match", () => {
      const questions = generateClarifyingQuestions("Architecture", {
        inputCompleteness: 0.8,
        aiSelfAssessment: 0.7,
        patternMatch: 0.3,
      });
    ...
    it("generates no questions for high confidence factors", () => {
      const questions = generateClarifyingQuestions("Test", {
