            ...
            suggestions: [
              {
                ...
                isExisting: true,
                confidence: 0.95,
                rationale: "Issue describes a bug",
                matchedPatterns: ["crash", "error"],
              },
              {
                label: "enhancement",
                isExisting: true,
                ...
                matchedPatterns: ["could"],
              },
              {
                label: "docs",
                isExisting: false,
                confidence: 0.3,
                rationale: "Might need docs",
                matchedPatterns: [],
              },
            ],
            ...
            suggestions: [
              {
                ...
                isExisting: true,
                confidence: 0.9,
                rationale: "Issue mentions crash and error behavior",
                matchedPatterns: ["crash"],
              },
            ],
            ...
            suggestions: [
              {
                ...
                isExisting: true,
                confidence: 0.9,
                rationale: "Existing label match",
                matchedPatterns: [],
              },
            ],
            overallConfidence: 0.9,
            ...
            suggestions: [
              {
                ...
                isExisting: true,
                confidence: 0.95,
                rationale: "Historical pattern match",
                matchedPatterns: ["crash"],
              },
            ],
            overallConfidence: 0.9,
            ...
            suggestions: [
              {
                ...
                matchedPatterns: ["crash", "error", "bug"],
              },
            ],
    ...
    it("should toggle includeNewProposals", async () => {
      ...
      mockGenerateObject.mockResolvedValue({
        object: {
          suggestions: [],
          newLabelProposals: [
            { name: "new-label", description: "D", color: "000000", rationale: "R" },
          ],
          overallConfidence: 0.7,
        },
      } as any);
