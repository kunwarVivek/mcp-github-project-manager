...
vi.mock("../../../src/services/TaskGenerationService", () => ({
  TaskGenerationService: vi.fn().mockImplementation(function () {
    return {
...
describe("FeatureExpansionService", () => {
  ...
  const mockFeature: FeatureRequirement = {
    ...
    userStories: ["As a user, I want to login with OAuth", "As a user, I want to enable MFA"],
    acceptanceCriteria: ["OAuth login works", "MFA can be enabled", "Session management works"],
