...
import type { PRDDocument, EnhancedTaskGenerationParams } from "../../domain/ai-types";
...
describe("TaskGenerationService - Enhanced Context Generation", () => {
  ...
  const mockPRD: PRDDocument = {
    ...
    successMetrics: ["Conversion rate > 3%", "Page load time < 2s", "User satisfaction > 4.5/5"],
    aiGenerated: true,
    ...
    const mockTasks = [
      {
        ...
        description:
          "Create a comprehensive product catalog with search and filtering capabilities",
        status: "TODO",
        priority: "HIGH",
        complexity: 5,
        estimatedHours: 40,
