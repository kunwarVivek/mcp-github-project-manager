...
MCPToolTestUtils.createTestSuite(
  "AI Task Management Tools E2E",
  "both"
)((utils: MCPToolTestUtils | undefined) => {
  ...
  describe("PRD Generation Tools", () => {
    it("should generate a PRD from project idea", async () => {
      ...
      const response = await utils.callTool(AI_COMPOUND_TOOL, {
        action: "generate_prd",
        projectIdea:
          "A modern task management application with AI-powered task prioritization and team collaboration features",
