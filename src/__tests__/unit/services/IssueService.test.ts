import { describe, expect, it, vi, beforeEach, Mocked, MockedClass, MockedFunction } from 'vitest';
import { IssueService, IssueComment, DraftIssue } from '../../../services/IssueService';
...
import { IssueEntity } from '../../../domain/entities';
