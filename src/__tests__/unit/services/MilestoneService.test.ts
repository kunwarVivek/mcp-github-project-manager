...
describe("MilestoneService", () => {
  ...
  describe("getMilestoneMetrics", () => {
    ...
    it("should throw error when milestone not found", async () => {
      ...
      await expect(service.getMilestoneMetrics("non-existent")).rejects.toThrow(DomainError);
    });
  });
  ...
  describe("deleteMilestone", () => {
    ...
    it("should throw error when delete fails", async () => {
      ...
      await expect(service.deleteMilestone({ milestoneId: "non-existent" })).rejects.toThrow(
        DomainError
      );
    });
  });
