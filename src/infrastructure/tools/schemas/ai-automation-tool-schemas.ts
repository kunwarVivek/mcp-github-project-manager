...
export const generateRoadmapTool: ToolDefinition<
  GenerateRoadmapArgs,
  z.infer<typeof AIRoadmapOutputSchema>
> = {
...
export const enrichIssueTool: ToolDefinition<
  EnrichIssueArgs,
  z.infer<typeof AIEnrichmentOutputSchema>
> = {
  name: "enrich_issue",
  title: "Enrich Issue",
  description:
...
export const enrichIssuesBulkTool: ToolDefinition<
  EnrichIssuesBulkArgs,
...
export const triageIssueTool: ToolDefinition<
  TriageIssueArgs,
  z.infer<typeof AITriageOutputSchema>
> = {
  name: "triage_issue",
  title: "Triage Issue",
  description:
...
export const triageAllIssuesTool: ToolDefinition<
  TriageAllIssuesArgs,
  z.infer<typeof BulkOperationResultSchema>
> = {
...
export const scheduleTriagingTool: ToolDefinition<
  ScheduleTriagingArgs,
