  ...
  try {
    ...
    try {
      ...
      process.stderr.write(
        "❌ You have uncommitted changes. Please commit or stash them before publishing."
      );
      process.exit(1);
    }
    ...
    try {
      ...
      console.log(
        "⚠️  GitHub release creation failed (gh CLI may not be installed). Create manually at:"
      );
      console.log(
        `   https://github.com/kunwarVivek/mcp-github-project-manager/releases/new?tag=v${newVersion}`
      );
    }
    ...
    console.log(
      `   GitHub: https://github.com/kunwarVivek/mcp-github-project-manager/releases/tag/v${newVersion}`
    );
  } catch (error) {
